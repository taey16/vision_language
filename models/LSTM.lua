...
function LSTM.bn_lstm(input_size, output_size, rnn_size, num_layer, dropout)
...
function LSTM.my_bn_lstm(input_size, output_size, rnn_size, num_layer, dropout, activation)
  dropout = dropout or 0.5 
